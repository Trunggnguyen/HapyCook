...
import com.example.happycook.Adapter.MyFotosAdapter;
import com.example.happycook.Adapter.PostAdapter;
import com.example.happycook.EditProfileActivity;
import com.example.happycook.FollowersActivity;
import com.example.happycook.Model.Post;
import com.example.happycook.Model.User;
import com.example.happycook.OptionsActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private PostAdapter myFotosAdapter;
    private List<Post> postList;

    private RecyclerView recyclerView_saves;
    private PostAdapter myFotosAdapter_saves;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        myFotosAdapter = new PostAdapter(getContext(), postList);
        recyclerView.setAdapter(myFotosAdapter);

        recyclerView_saves = view.findViewById(R.id.recycler_view_save);
        recyclerView_saves.setHasFixedSize(true);
        LinearLayoutManager mLayoutManagers = new GridLayoutManager(getContext(), 1);
        recyclerView_saves.setLayoutManager(mLayoutManagers);
        postList_saves = new ArrayList<>();
        myFotosAdapter_saves = new PostAdapter(getContext(), postList_saves);
